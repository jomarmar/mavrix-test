...
describe('mavrixAgenda', function() {
  ...
  describe('main', function() {
    ...
    it('add new contact', function() {
      ...
      var contactList = element.all(by.repeater("contact in vm.filterList | orderBy:contact.lastname | start: (vm.pagination.currentPage - 1) * vm.pagination.numPerPage | limitTo: vm.pagination.numPerPage track by contact.email"));
